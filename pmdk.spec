...
find %{buildroot} -name "*pmem2*" -type f -exec rm -f {} \;
find %{_includedir} -name "libpmem2*" -exec rm -rf {} \;
find %{_libdir} -name "libpmem2*" -type f -exec rm -f {} \;
find %{_mandir} -name "pmem2*" -type f -exec rm -f {} \;
